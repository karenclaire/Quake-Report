...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    private int getMagnitudeColor(double magnitude) {
        ...
        // the switch statement cannot accept a double value, so we should convert our decimal
        // magnitude value into an integer. use the Math class to do some handy mathematical
        // calculations. In this case, we can take the “floor” of the decimal magnitude value
